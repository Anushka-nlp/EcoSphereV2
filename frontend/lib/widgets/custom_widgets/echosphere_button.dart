...
class EchoSphereButton extends StatelessWidget {
  final Widget? child;
...
class EchoSphereButton2 extends StatelessWidget {
  final Widget? child;
...
class SoftContainer extends StatelessWidget {
  final Widget? child;
  const SoftContainer({super.key, this.child});

  @override
  Widget build(BuildContext context) {
    return EchoSphereContainer(child: child);
  }
}
