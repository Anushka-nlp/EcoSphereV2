...
class EchoSphereImage extends StatefulWidget {
  ...
  @override
  State<EchoSphereImage> createState() => _EchoSphereImageState();
}

class _EchoSphereImageState extends State<EchoSphereImage> {
  ...
  @override
  void didUpdateWidget(EchoSphereImage oldWidget) {
