...
class EchoSphereExpansionTile extends StatelessWidget {
  final String title;
  final Widget content;
  final bool initialExpanded;
  final Widget? leading;

  const EchoSphereExpansionTile({
    super.key,
    required this.title,
...
class EchoSphereCard extends StatelessWidget {
  final Widget child;
