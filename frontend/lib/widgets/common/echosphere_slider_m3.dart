...
class EchoSphereSliderM3Theme {
  ...
  EchoSphereSliderM3Theme _resolve(BuildContext context) {
    final scheme = Theme.of(context).colorScheme;
    final resolvedActive = activeColor ?? scheme.primary;
    return EchoSphereSliderM3Theme(
  ...
  EchoSphereSliderM3Theme copyWith({
    Color? activeColor,
    Color? inactiveColor,
...
class EchoSphereSliderM3 extends StatelessWidget {
  final double value;
  ...
  final EchoSphereSliderM3Theme theme;

  const EchoSphereSliderM3({
    super.key,
    required this.value,
    ...
    this.label,
    this.focusNode,
    this.theme = const EchoSphereSliderM3Theme(),
  });
  ...
  Widget build(BuildContext context) {
    ...
    return SliderTheme(
      data: SliderThemeData(
        ...
        trackShape: _EchoSphereSliderM3TrackShape(
        ...
        thumbShape: _EchoSphereSliderM3ThumbShape(
...
class _EchoSphereSliderM3TrackShape extends SliderTrackShape {
  const _EchoSphereSliderM3TrackShape({
...
class _EchoSphereSliderM3ThumbShape extends SliderComponentShape {
  const _EchoSphereSliderM3ThumbShape({
    required this.width,
