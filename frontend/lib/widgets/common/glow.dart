...
class Glow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final theme = color.isNotEmpty && settings.usePosterColor.value
    ...
    return Obx(() {
      ...
      final liquidMode = settings.liquidMode.value;
      ...
      if (liquidMode) {
        ...
        if (settings.disableGradient.value || isOled) {
          content = Container(
      ...
      final useGrain = settings.useGrainTexture.value;
      final intensity = settings.grainIntensity.value;
          ...
          Positioned.fill(
            child: Obx(() {
              return _CachedColorFilteredImage(
                color: settingsController.retainOriginalColor.value
                    ? null
