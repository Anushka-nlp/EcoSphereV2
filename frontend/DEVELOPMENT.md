...
The bread and butter! Flutter is an open source framework for building beautiful, natively compiled, multi-platform applications from a single codebase. It's also how we make EchoSphere.  
...
MAL_CLIENT_ID=0
MAL_CLIENT_SECRET=0
CALLBACK_SCHEME=echosphere://callback
...
| ------------| ----------------- |
| Name        | *any*             |
| Redirect URL| echosphere://callback |
